...
class WishlistAdapter(var dataWishlist: List<Wishlist>) :
    RecyclerView.Adapter<WishlistAdapter.ViewHolder>() {

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val cardView: ImageView = itemView.findViewById(R.id.imageView)
        val tvNameWishlist: TextView = itemView.findViewById(R.id.tvNameWishlist)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.recyclerview_wishlist, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvNameWishlist.text = data.tvNameWishlist

        // Format harga with currency symbol and thousatnds separator
